"""
Sensor operators for RYUO — Airflow-compatible poll-based waiting tasks.
...
from ryuo.airflow_shim import BaseOperator
...
class BaseSensorOperator(BaseOperator):
    ...
    def to_dict(self):
        """Serialize to a dict compatible with RYUO's SensorConfig JSON schema."""
        d = super().to_dict()
