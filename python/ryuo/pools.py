"""
Pool information helper for RYUO Python tasks.
...
def _get_api_key():
    key = os.environ.get("RYUO_API_KEY", "")
    if not key:
        raise EnvironmentError("RYUO_API_KEY environment variable is required")
    return key
...
def get_pool_info(pool_name: str = "default"):
    ...
    Environment variables:
        RYUO_API_KEY   — API key for authentication (default: ryuo_admin_key)
        RYUO_BASE_URL  — Base URL of the RYUO API server (default: http://localhost:3000)
    """
